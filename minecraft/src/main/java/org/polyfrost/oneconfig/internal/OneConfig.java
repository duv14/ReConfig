...
public class OneConfig
    ...
    private static final Logger LOGGER = LogManager.getLogger("ReConfig");
    ...
    private static void registerCommands() {
        ...
        var node = CommandManager.literal("reconfig")
                .executes(executor)
                .then(CommandManager.literal("delete")
                        .executes((ctx) -> {
                            ctx.getSource()
                                    .sendFeedback(Component.literal(
                                            "Deleted ReConfig UI. Please make a report if you were having issues!"));
                            return 1;
                        })
                )
        ...
        OneConfigConfig.setOpenAction(pressed -> {
            ...
            try {
                ...
                Minecraft.getInstance().gui.hud.getChat()
                        ...
                        .addClientSystemMessage(Component.literal("Failed to open ReConfig UI: " + t.getMessage() + ". Please report this!")
                                .withStyle(
                                        ChatFormatting.RED));
                throw t;
            }
...
//        //#endif
    ...
    private static void showFirstLaunchNotification() {
        ...
        firstLaunchToast = Notifications.send(
                ...
                Notifications.icon("/assets/oneconfig/brand/reconfig-logo.png", 64),
                -1f,
                null,
                OneConfigUIScreen::openLastSession);
    }
    ...
    private void init() {
        ...
        LOGGER.info("Loading ReConfig v{}", v);
        ...
        org.polyfrost.oneconfig.internal.reconfig.ReConfigSocialBootstrap.start();
        org.polyfrost.oneconfig.internal.reconfig.ReConfigModuleRuntime.start();
        ...
        initialized = true;
        LOGGER.info("ReConfig initialization took {}ms", (System.nanoTime() - t1) / 1_000_000.0);
    }
