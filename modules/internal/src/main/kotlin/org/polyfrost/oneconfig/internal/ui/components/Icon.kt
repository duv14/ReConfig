...
fun Icon(
    ...
    val modulePath = "/assets/oneconfig/ico/reconfig-modules/$iconName.svg"
    val defaultPath = modulePath.takeIf(::iconResourceExists) ?: iconName.toIconResourcePath()
    val overridePath = theme.iconOverrides[iconName]?.toIconResourcePath()
    val path = overridePath?.takeIf(::iconResourceExists)
        ?: defaultPath.takeIf(::iconResourceExists)
        ?: "qol".toIconResourcePath()
