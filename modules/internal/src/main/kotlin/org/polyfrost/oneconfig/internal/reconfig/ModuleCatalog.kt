...
object ModuleCatalog { val modules=listOf(
    ...
    ClientModule("cps","CPS Counter","Left and right clicks in the last second","cps",listOf(key(default=0),info("hud_notice","Move and resize this HUD in Edit HUD"))),
    ClientModule("fps","FPS Counter","Current frames per second","fps",listOf(key(default=0),info("hud_notice","Move and resize this HUD in Edit HUD"))),
    ClientModule("keystrokes","Keystrokes","Movement, jump and mouse button overlay","keystrokes",listOf(key(default=0),info("hud_notice","Move and resize this HUD in Edit HUD"))),
    ClientModule("armor_status","Armor Status","Equipped armor and remaining durability","armor-status",listOf(key(default=0),info("hud_notice","Move and resize this HUD in Edit HUD"))),
    ClientModule("effect_status","Effect Status","Active effects and remaining timers","effect-status",listOf(key(default=0),info("hud_notice","Move and resize this HUD in Edit HUD"))),
    ClientModule("coordinates","Coordinates / Biome","Position, facing direction and biome","coordinates",listOf(key(default=0),info("hud_notice","Move and resize this HUD in Edit HUD"))),
    ClientModule("combo_counter","Combo Counter","Consecutive player hits without taking damage","combo-counter",listOf(key(default=0),info("hud_notice","Move and resize this HUD in Edit HUD"))),
    ClientModule("inventory_hud","Compact Inventory","A miniature inventory grid on your HUD","inventory-hud",listOf(key(default=0),info("hud_notice","Move and resize this HUD in Edit HUD"))),
    ClientModule("memory_monitor","Memory Monitor","Used, allocated and maximum heap with a high-usage warning","memory-monitor",listOf(key(default=0),info("hud_notice","Move and resize this HUD in Edit HUD. High usage is a warning, not a prediction of every crash."))),
    ClientModule("server_status","Server Status","Reported ping and available server timing information","server-status",listOf(key(default=0),info("hud_notice","Move and resize in Edit HUD. Exact packet loss and TPS are not supplied by ordinary servers."))),
