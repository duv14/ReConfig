...
val PolyGlassDark = UITheme(
    ...
    UIBranding("assets/oneconfig/brand/reconfig-wordmark.png"),
    UITypography(
        family = FontFamily(
            Font("assets/oneconfig/fonts/ReConfig/BricolageGrotesque.ttf", FontWeight.Normal),
            Font("assets/oneconfig/fonts/ReConfig/BricolageGrotesque.ttf", FontWeight.Medium),
            Font("assets/oneconfig/fonts/ReConfig/BricolageGrotesque.ttf", FontWeight.SemiBold),
            Font("assets/oneconfig/fonts/ReConfig/BricolageGrotesque.ttf", FontWeight.Bold)
        )
    )
)
