...
public class OneConfigConfig extends Config {
    ...
    @Color(
        title = "Accent Color",
        description = "Changes ReConfig controls, highlights, and the wordmark",
        icon = "paintbrush",
    ...
    public static boolean enableUIAmbience = false;
    ...
    public OneConfigConfig() {
        super("reconfig.json", "assets/oneconfig/brand/reconfig-logo.png", "ReConfig", Category.QOL);
        INSTANCE = this;
    }
    ...
    protected void initialize(boolean byConfigManager) {
        ...
        org.polyfrost.oneconfig.internal.ui.themes.ProviderKt.updateAccent();
        addCallback(
            "accentColor", (PolyColor v) -> {
                accentColor = v;
                ThemeConfig.accentColor = v;
                org.polyfrost.oneconfig.internal.ui.themes.ProviderKt.updateAccent();
                return false;
            });
        addCallback(
