...
class CameraControlsTest(unittest.TestCase):
    def test_mouse_camera_uses_public_inversion_getters(self):
        ...
        self.assertIn('reconfig.Mixin_ReConfigMouseCamera', mixins)
    ...
    def test_toggle_hook_no_longer_overrides_saved_options(self):
        ...
        self.assertNotIn('BooleanSupplier', source)
        ...
        self.assertIn('sprintLatched', runtime)
        self.assertIn('physicalKeyDown', runtime)
