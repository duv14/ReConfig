...
public final class CombatConfigTest {
    ...
    public static void main(String[] args) {
        ...
        check(config.getGlobalArgb() == 0xFFFFFFFF);
        config.setGlobalColor("#f28c28");
        check(config.getGlobalArgb() == 0xFFF28C28);
        ...
        check(config.colorForPlayer("somebody").getAsInt() == 0xFFF28C28);
        check(config.colorForPlayer("example").getAsInt() == two.getArgb());
